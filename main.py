    ...
    if "message" in body:
        ...
        if data_str.startswith("approve_rc_"):
            ...
            if booking:
                ...
                send_telegram_message(booking["user_id"], "🎉 <b>Badhai ho!</b> Host ne aapki booking request accept kar li hai. Ab aap app me 'My Bookings' se session join kar sakte hain!")
                requests.post(f"{TELEGRAM_API_URL}/editMessageText", json={
